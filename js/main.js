...
function Products(name, description, price, clasification, earningPorcentage, sixMonthsPrices=[], quantitySold, caducity, caducityDays) {
    this.name = name;
    ...
    this.caducityDays = caducityDays;
...
const fifteenDaysOrLess = products.filter(item => {
    return item.caducityDays < 15;
})
console.log(fifteenDaysOrLess)